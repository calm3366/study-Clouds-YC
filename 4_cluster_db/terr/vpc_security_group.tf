...
#   network_id  = yandex_vpc_network.network.id
  ...
  #   v4_cidr_blocks    = concat(yandex_vpc_subnet.public_subnet.v4_cidr_blocks, yandex_vpc_subnet.public_subnet2.v4_cidr_blocks, yandex_vpc_subnet.public_subnet3.v4_cidr_blocks)
  #   from_port         = 0
  #   to_port           = 65535
  # }
  # ingress {
